...
[9]Footnote 1: This issue is preserved for our review. Defendant's attorney specifically objected to the trial court's decision to reseat the alternate juror on the ground that discharged jurors "are no longer jurors" and joined cocounsel's argument on this issue (CPL 470.05 [2]). Moreover, "in response to defendant's protest, [the court] 'expressly decided the question raised on appeal' " ([People v Smith, 22 NY3d 462, 465 [2013]](https://miranda.jurisware.com/case/2013_08371/)).
