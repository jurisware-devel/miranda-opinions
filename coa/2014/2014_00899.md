...
Our standard of review for legal sufficiency is well settled. Viewing the evidence in the light most favorable to the People, we must determine whether "there is a valid line of reasoning {**22 NY3d at 537}and permissible inferences from which a rational jury could have found the elements of the crime proved beyond a reasonable doubt" ([4][People v Danielson, 9 NY3d 342, 349 [2007] [internal quotation marks and citations omitted]). Moreover, "the People are entitled to the benefit of eve](https://miranda.jurisware.com/case/2007_09814/)ry reasonable inference to be drawn from the evidence" (People v Cintron, 95 NY2d 329, 332 [2000] [emphasis added]).
