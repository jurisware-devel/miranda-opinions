...
Again, defendant raises the alternative argument that the failure to preserve this issue constituted ineffective assistance of counsel. Under the circumstances, keeping in mind that defendant succeeded in achieving certain redactions as well as a proper limiting instruction that the jury must be presumed to have obeyed ([7]see [e.g. People v Morris, 21 NY3d 588, 598 [2013]; People v Davis, 58 NY2d 1102, 1104 [1983]), we cannot conclude defense counsel provided less than meaningf](https://miranda.jurisware.com/case/2013_06633/)ul representation with respect to the issue of the letters (see generally People v Baldi, 54 NY2d 137, 147 [1981]). Moreover, given the limiting instruction, the result of defendant's appeal would not have been different had defense counsel preserved the issue by asking for further redactions (see generally Strickland v Washington, 466 US 668, 694 [1984]).
