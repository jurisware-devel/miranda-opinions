...
Stating the rule is simple. Determining a declarant's mental state—that is, whether at the time the utterance was made a declarant was in fact under the stress of excitement caused by an external event sufficient to still his or her reflective faculties—is considerably more difficult.^[4][FN3](#fn-3-1)
