...
The "primary government interest" underlying SORA is "protecting vulnerable populations[,] and in some instances the public, from potential harm" posed by sex offenders (L 1995, ch 192, § 1 ["Legislative purpose or findings"]; see also [People v Mingo, 12 NY3d 563, 574 [2009]](https://miranda.jurisware.com/case/2009_04700/)). To safeguard this interest, the Legislature sought to furnish law enforcement with sufficient information to track and monitor a sex offender's whereabouts (see e.g. Correction Law § 168-b [1] [a]; § 168-c [2]; § 168-d [2]; § 168-e [1]; §§ 168-f, 168-j, 168-k). Concomitantly, the Board recognizes that sex offenders are more likely to reoffend if their living situation upon release "gives them access to victims or a reduced probability of detection" (SORA Commentary, at 17 [risk factor 15]).
