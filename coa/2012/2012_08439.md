...
"Whether an error in the proceedings relating to one count requires reversal of convictions on other jointly tried counts is a question that can only be resolved on a case-by-case basis" (People v Baghai-Kermani, 84 NY2d 525, 532 [1994]). We must evaluate "the individual facts of the case, the nature of the error and its potential for prejudicial impact on the over-all outcome" ([People v Concepcion, 17 NY3d 192, 196-197 [2011]](https://miranda.jurisware.com/case/2011_05110/) [internal quotation marks and citation omitted]; see also People v Doshi, 93 NY2d 499, 505 [1999]). Reversal is required if "there is a reasonable possibility that the jury's decision to convict on the tainted counts influenced its guilty verdict on the remaining counts in a meaningful way" (Doshi, 93 NY2d at 505 [internal quotation marks and citation omitted]; see also [People v Daly, 14 NY3d 848, 849 [2010]](https://miranda.jurisware.com/case/2010_03754/)). [*7]
