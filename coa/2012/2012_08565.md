...
The majority contends that this case is different from Fuller and more akin to our decision in [4]People v Echevarria (6 NY3d 89, 91 [2005]). The majority distinguishes Fuller on the basis that in that case "we did not consider the impact of a defendant's request for a mistrial with knowledge of the impending retrial, prior to the acceptance of a partial verdict" (majority op at 265). However, both the defendant in this case and the one in Fuller were acting under the mistaken belief that the People were allowed to retry the unresolved counts^[5][FN*] and were ignorant of the implications of CPL 300.40 (3) (b) and 300.50 (4).
