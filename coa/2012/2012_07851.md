...
We have held that, even where a vehicle has been lawfully impounded, the [*4]inventory search itself must be conducted pursuant to "an established procedure" that is related "to the governmental interests it is intended to promote" and that provides "appropriate safeguards against police abuse" (People v Galak, 80 NY2d 715, 716 [1993]; [4]see also People v Johnson, 1 NY3d 252 [2003]; [People v Gomez, 13 NY3d 6 [2009]](https://miranda.jurisware.com/case/2009_05371/)). Defendant argues that the inventory search in this case failed to meet this requirement. We reject the argument.
