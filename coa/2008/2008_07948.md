...
The indictment in this case tracks the language of these statutes. It alleges the elements of murder in the first degree, including a killing "in the course of" and "in furtherance of" a first degree kidnapping, and it also alleges the elements of first degree kidnapping, including the abduction and the death of the person abducted. Defendant argues that the indictment is nevertheless insufficient because it violates a rule against "double counting" that defendant finds in [3]People v Cahill (2 NY3d 14 [2003]). Defendant reads Cahill too broadly.
