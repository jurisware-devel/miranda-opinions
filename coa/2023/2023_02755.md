...
The constitutional right to a public trial " 'has long been regarded as a fundamental privilege of the defendant in a criminal prosecution' " ([3]People v Roberts, 31 NY3d 406, 425 [2018], quoting[4] People v Martin, 16 NY3d 607, 611 [2011]). The presumption is that trials will be open to the public, and a trial court's discretion to exclude the public from criminal proceedings "must be exercised only when unusual circumstances necessitate it" (Martin, 16 NY3d at 611 [internal quotation marks omitted]).
